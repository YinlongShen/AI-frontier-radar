...
不是又一个 arXiv 关键词订阅。这个工具的核心假设是：**判断一篇工作值不值得看，"谁做的"比"标题里有什么词"可靠得多。**

---

## 它解决的具体问题

Sutton 那篇讲 enactivism 的工作五月就发了，你八月才刷到。

常规的每日 arXiv 推送救不了这种情况 —— 它只看"今天新增的论文"，一篇五月的论文永远不会再出现在任何一天的推送里。这个工具用两条机制堵这个洞：
